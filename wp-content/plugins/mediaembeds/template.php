...
<?php 
	...
	echo "<iframe src='$me_server_url/?post_type=mediaembed&name=$post->post_name&view=iframe.html' id='meid_$post->ID' name='meid_$post->ID' class='embediframe' data-media_server_url='$me_server_url' seamless style='width:100%;height:300px;border:0;overflow: hidden;' scrolling='no'></iframe>";  // outside value not accessible
